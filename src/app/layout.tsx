...
export const metadata: Metadata = {
  title: "Alpine Retreat Hotel | Luxury Swiss Alps Resort",
  description: "Experience unparalleled Alpine luxury at Alpine Retreat Hotel in the Swiss Alps. Premium accommodations, world-class amenities, and breathtaking mountain views.",
  keywords: "luxury hotel Swiss Alps, Alpine resort, mountain accommodation, premium suites, Switzerland hospitality",
  metadataBase: new URL("https://alpine-retreat.com"),
  alternates: {
    canonical: "https://alpine-retreat.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Alpine Retreat Hotel | Swiss Alps Luxury",
    description: "Discover Alpine luxury with stunning mountain views, fine dining, and exceptional service.",
    type: "website",
    siteName: "Alpine Retreat Hotel",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763919181620-ipj3bgud.jpg",
        alt: "Alpine Retreat Hotel mountain view"
      }
    ]
  },
  twitter: {
    ...
    description: "Luxury Swiss Alps resort with premium accommodations and world-class amenities.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763919181620-ipj3bgud.jpg"]
  }
};
